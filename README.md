...
OpenBSD's historical focus on isolation from attacks from outside the system neglects attacks from below or inside neglects a focus on both system and data integrity. There is likely prior art from IBM that would be insightful for comparison.
