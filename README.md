...
This essay limits the topic to auditability and security-hardening (tamper resistance) of the build process and not higher-level theoretical limitations and practical problems in compiler design and formal verification or the peculiar visibility of kernel objects in user space.
